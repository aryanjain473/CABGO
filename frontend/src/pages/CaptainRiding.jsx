...
const CaptainRiding = () => {
  ...
  return (
    ...
    <div className='fixed p-6 top-0 flex items-center justify-between w-screen'>
      ...
      <Link to='/captain-home' className="right-2 top-2 h-10 w-10 bg-white flex items-center justify-center rounded-full top-2 ">
 ...
 <button className=' bg-green-600 text-white font-semibold p-3 px-10 rounded-lg'>Complete Ride</button>
   ...
   <div ref={finishRidePanelRef} className="fixed w-full z-10 bottom-0 translate-y-full bg-white px-3 py-12">
