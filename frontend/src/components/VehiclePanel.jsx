    ...
    return(
        ...
        <h3 className='text-2xl font-semibold mb-5'>Choose a Vehicle</h3>
              ...
              className='flex border-2 border-black rounded-xl w-full items-centre mb-2 justify-between'>
                <img className="h-12" src="https://static.vecteezy.com/system/resources/thumbnails/040/963/391/small/ai-generated-hyundai-car-transparent-background-generative-ai-free-png.png" alt=""/>
                <div className='w-1/2'>
